...
{
    public class Kursiyer_EkleModel
    {
        public int ID { get; set; } // DB’den dönecek ID
        public string ADI { get; set; }
        public string SOYADI { get; set; }
        public int ID_GRUP_KARTI { get; set; }
...
public class SertifikaSinifi
    ...
    public class Donem
    {
        public int Id { get; set; }
        public string DonemAdi { get; set; }
        public override string ToString() => DonemAdi; // ComboBox için
    }
    }
}
